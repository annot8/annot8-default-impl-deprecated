...
public class DefaultText extends AbstractContent<String> implements Text {
  ...
  private DefaultText(String id,  String name,
  ...
  public static class Builder extends AbstractContentBuilder<String, DefaultText> {
    ...
    @Override
    public DefaultText create(String id, String name,
        ImmutableProperties properties, Supplier<String> data) {
  ...
  public static class BuilderFactory
      extends AbstractContentBuilderFactory<String, DefaultText> {
    ...
    public Content.Builder<DefaultText, String> create(Item item,
        SaveCallback<DefaultText, DefaultText> saver) {
